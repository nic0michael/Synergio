...
public class MigrateToSQL {
    ...
    private static final String SCHEMA_SQL =
        ...
        "    \"state\" INT\n" +
        ");\n\n" +
        "CREATE TABLE IF NOT EXISTS \"customer-vehicle\" (\n" +
        "    \"id\" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,\n" +
        "    \"customer_id\" INT,\n" +
        "    \"date\" DATE,\n" +
        "    \"customer_name\" VARCHAR(255),\n" +
        ...
        "    \"state\" INT\n" +
        ");\n\n" +
        "CREATE TABLE IF NOT EXISTS \"service-record\" (\n" +
        "    \"id\" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,\n" +
        "    \"date\" DATE,\n" +
        "    \"service_date\" DATE,\n" +
        "    \"recurring_date\" DATE,\n" +
        ...
        "    FOREIGN KEY (\"service_record_id\") REFERENCES \"service-record\"(\"id\")\n" +
        ");\n";
    ...
    private static void generateData() throws IOException {
        ...
        try (PrintWriter writer = new PrintWriter(new FileWriter(dataFile))) {
            ...
            processCsv(DATA_DIR + "customer_vehicles.csv", writer, (parts, w) -> {
                ...
                w.printf("INSERT INTO \"customer-vehicle\" (\"id\", \"customer_id\", \"date\", \"customer_name\", \"cellphone\", \"customer_address\", \"vehicle_reg_number\", \"vehicle_make_model\", \"colour\", \"vin_number\", \"state\") VALUES (%s, %s, %s, '%s', '%s', '%s', '%s', '%s', '%s', '%s', %s);%n",
